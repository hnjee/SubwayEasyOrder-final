...
<!-- Pager -->
	...
	<div style="margin: 0 auto;">
	  	...
	  	<c:if test="${pager.curPage>1}">
			    <li class="page-item"><a class="page-link" href="./byProduct?curPage=${pager.startNum-1}&from=${from}&to=${to}">이전</a></li>
		</c:if>	 
	 	 ...
	 	 <c:if test="${pager.curPage<pager.totalPage}">
			    <li class="page-item"><a class="page-link" href="./byProduct?curPage=${pager.lastNum+1}&from=${from}&to=${to}">다음</a></li>
		</c:if>
