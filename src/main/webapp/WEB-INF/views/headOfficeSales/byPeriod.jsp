...
<body>
 <div id="wrapper">
	...
	<h3 id="titleName" style="margin-top: 50px;">기간별 매출</h3> 
	
	<form action="./byPeriod">
	<div class="serach">
...
<c:if test="${pager.totalPage>0}">
	<div style="margin: 0 auto;">
	  	...
	  	<c:if test="${pager.curPage>1}">
			    <li class="page-item"><a class="page-link" href="./byPeriod?curPage=${pager.startNum-1}&from=${from}&to=${to}">이전</a></li>
		</c:if>	 
			
	  	<c:forEach begin="${pager.startNum}" end="${pager.lastNum}" var="i">
			    <li class="page-item"><a class="page-link" href="./byPeriod?curPage=${i}&from=${from}&to=${to}">${i}</a></li>
	 	 </c:forEach>
	 	 
	 	 <c:if test="${pager.curPage<pager.totalPage}">
			    <li class="page-item"><a class="page-link" href="./byPeriod?curPage=${pager.lastNum+1}&from=${from}&to=${to}">다음</a></li>
		</c:if>
