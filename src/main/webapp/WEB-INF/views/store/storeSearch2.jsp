...
<body>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e8f222776d2a9d10e62a6e476046e2d1&libraries=services"></script>
	<script>
		// 마커를 담을 배열입니다
		var markers = [];
		...
		function findStore(title) {
			var name = title.replace("써브웨이 ", "");
			if (confirm(title + "에서 주문하시겠습니까?")) {
				$.ajax({
					type : 'GET',
					url : "./findStore",
					data : {
