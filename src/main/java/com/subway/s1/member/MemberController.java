...
//	public ModelAndView oftenStoreDel(MemberVO memberVO,HttpSession session)throws Exception{
//		ModelAndView mv = new ModelAndView();
...
//		session.setAttribute("store", storeList);
//		session.setAttribute("storeCount", storeCount);
//		return mv;
//	}
//	
